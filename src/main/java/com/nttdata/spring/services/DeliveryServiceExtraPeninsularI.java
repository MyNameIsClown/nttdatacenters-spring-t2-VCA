...
/**
 * Implementacion de DeliveryService para Extra peninsular
 * @author Victor Carrasco
 *
 */
@Service("envioPeninsular")
public class DeliveryServiceExtraPeninsularI implements DeliveryServiceI{
	...
	public Pedido crearPedido(Integer id, String destinatario, String direccionEntrega) {
		...
		newPedido.setEsEnvioPeninsular(false);
		newPedido.setProductos(new ArrayList<>());
